...
public class pureSquareCAD extends PApplet {
...
public void drawShapeArray(int[] localShapeCodeArray){
...
public void setColor(int colorSelectLocal){
...
public void doTheThing(int localByte){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "pureSquareCAD" };
    if (passedArgs != null) {
