...
String myString = "toomanysecrets";
char myChar;
...
void draw(){
   ...
   for(int letterIndex = 0;letterIndex < myString.length();letterIndex++){
        currentGlyph = append(currentGlyph,0305);
        for(int bullshitIndex = 0;bullshitIndex < letterIndex;bullshitIndex++){
         currentGlyph = append(currentGlyph,0300);
       }       
       printCharacter(myString.charAt(letterIndex));//3
   }
   /*
   currentGlyph = append(currentGlyph,0305);
   printCharacter(myString.charAt(0));
   currentGlyph = append(currentGlyph,0305);
   currentGlyph = append(currentGlyph,0300);
   printCharacter(myString.charAt(1));
   currentGlyph = append(currentGlyph,0305);
   currentGlyph = append(currentGlyph,0300);
   currentGlyph = append(currentGlyph,0300);
   printCharacter(myString.charAt(2));
   currentGlyph = append(currentGlyph,0305);
   currentGlyph = append(currentGlyph,0300);
   currentGlyph = append(currentGlyph,0300);
   currentGlyph = append(currentGlyph,0300);
   printCharacter(myString.charAt(3));
      currentGlyph = append(currentGlyph,0305);
   currentGlyph = append(currentGlyph,0300);
   currentGlyph = append(currentGlyph,0300);
   currentGlyph = append(currentGlyph,0300);
   currentGlyph = append(currentGlyph,0300);
   printCharacter(myString.charAt(4));
      currentGlyph = append(currentGlyph,0305);
   ...
   currentGlyph = append(currentGlyph,0300);
   currentGlyph = append(currentGlyph,0300);
   printCharacter(myString.charAt(5));
   currentGlyph = append(currentGlyph,0305);
   currentGlyph = append(currentGlyph,0300);
   currentGlyph = append(currentGlyph,0300);
   currentGlyph = append(currentGlyph,0300);
   ...
   currentGlyph = append(currentGlyph,0300);
   currentGlyph = append(currentGlyph,0300);
   printCharacter(myString.charAt(6));
*/
  noLoop();
}

void printCharacter(char localChar){
  roctalIndex = 0; 
  int myInt = int(localChar);
   roctalOriginX = 8*4*roctalSide*((myInt - 0141)%8);
   roctalOriginY = 300 + 8*4*roctalSide*((myInt - 0141)/8);
   readRoctalSequence(); 
